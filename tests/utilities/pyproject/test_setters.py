...
def describe_add_dependency():
    ...
    def chains_nested_optional_keys():
        src = dedent("""
            [project]
            name = "my-package"
        """)
...
def describe_remove_dependency():
    def removes_from_main_dependencies(pyproject_example: PyprojectTOML):
    ...
    def respects_ignored_sections(pyproject_example: PyprojectTOML):
